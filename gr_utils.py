...
class Flagging(gr.FlaggingCallback):
    ...
    def flag(self, flag_data, flag_option=None, flag_index = None, username = None) -> int:
        ...
        prompt, ddim_steps, sampler_name, use_GFPGAN, prompt_matrix, ddim_eta, n_iter, n_samples, cfg_scale, requested_seed, height, width, images, seed, comment = flag_data
        ...
        with open("log/log.csv", "a", encoding = 'utf8', newline='') as file:
            ...
            for i, filedata in enumerate(images):
                filename = f"log/images/{filename_base}" + ("" if len(images) == 1 else "-" + str(i+1)) + ".png"
